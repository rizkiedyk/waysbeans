      ...
      {transaction
        ...
        ?.map((item, index) => {
          return (
            <div
              key={index}
              className="d-flex align-items-center justify-content-between mb-2 p-4"
              style={{ backgroundColor: "#F6E6DA", width: 524, height: 145 }}
            >
              <div className="d-flex align-items-center ">
                ...
                <div className="ms-4">
                  <p
                    className="m-0"
                    style={{ color: "#613D2B", fontWeight: 900 }}
                  >
                    {item.products.product_name}
                  </p>
                  <p
                    className="m-0 mt-1"
                    style={{ color: "#974A4A", fontSize: 14 }}
                  >
              ...
              <div className="d-flex flex-column justify-content-center align-items-center">
                <img
                  src={LogoBrand}
                  alt="logo-brand"
                  style={{ width: 73, height: 22, margin: "10px 0" }}
                />
                <img src={Barcode} alt="qr" style={{ width: 50, height: 50 }} />
                {item.status === "pending" ? (
                  <div
                    className="font-size-14px text-center rounded py-1"
                    style={{
                      width: "100%",
                      color: "#FF9900",
